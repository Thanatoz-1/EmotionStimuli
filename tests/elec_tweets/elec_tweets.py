...
# eval_elec_exp.SaveDoc("doc_elec_exp.json")
# eval_elec_tar.SaveDoc("doc_elec_tar.txt")
# eval_elec_cue.SaveDoc("doc_elec_cue.txt")
# eval_elec_cse.SaveDoc("doc_elec_cse.txt")

eval_elec_exp.SaveEval("eval_elec_exp.txt")
eval_elec_tar.SaveEval("eval_elec_tar.txt")
eval_elec_cue.SaveEval("eval_elec_cue.txt")
eval_elec_cse.SaveEval("eval_elec_cse.txt")

...
# eval_gne_cue_j.SaveDoc("doc_gne_cue_j.txt")
# eval_gne_cue_a.SaveDoc("doc_gne_cue_a.txt")
# eval_gne_cue_s.SaveDoc("doc_gne_cue_s.txt")
# eval_gne_cue_o.SaveDoc("doc_gne_cue_o.txt")

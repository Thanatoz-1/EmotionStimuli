...
eval_gne_exp.SaveDoc("tests/reman/doc_reman_exp.json")
eval_gne_tar.SaveDoc("tests/reman/doc_reman_tar.json")
# eval_gne_cue_j.SaveDoc("tests/reman/doc_reman_cue_j.json")
# eval_gne_cue_a.SaveDoc("tests/reman/doc_reman_cue_a.json")
# eval_gne_cue_s.SaveDoc("tests/reman/doc_reman_cue_s.json")
# eval_gne_cue_o.SaveDoc("tests/reman/doc_reman_cue_o.json")
# eval_gne_cse.SaveDoc("tests/reman/doc_reman_cse.json")

eval_gne_exp.SaveEval("tests/reman/eval_reman_exp.txt")
eval_gne_tar.SaveEval("tests/reman/eval_reman_tar.txt")
eval_gne_cue_j.SaveEval("tests/reman/eval_reman_cue_j.txt")
eval_gne_cue_a.SaveEval("tests/reman/eval_reman_cue_a.txt")
eval_gne_cue_s.SaveEval("tests/reman/eval_reman_cue_s.txt")
eval_gne_cue_o.SaveEval("tests/reman/eval_reman_cue_o.txt")
eval_gne_cse.SaveEval("tests/reman/eval_reman_cse.txt")

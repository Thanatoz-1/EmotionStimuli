...
# eval_gne_cue_j.SaveDoc("doc_gne_cue.txt")
# eval_gne_cue_a.SaveDoc("doc_gne_cue.txt")
# eval_gne_cue_s.SaveDoc("doc_gne_cue.txt")
# eval_gne_cue_o.SaveDoc("doc_gne_cue.txt")
# eval_gne_cse.SaveDoc("doc_gne_cse.txt")

eval_gne_exp.SaveEval("eval_gne_exp.txt")
eval_gne_tar.SaveEval("eval_gne_tar.txt")
eval_gne_cue_j.SaveEval("eval_gne_cue.txt")
eval_gne_cue_a.SaveEval("eval_gne_cue.txt")
eval_gne_cue_s.SaveEval("eval_gne_cue.txt")
eval_gne_cue_o.SaveEval("eval_gne_cue.txt")
eval_gne_cse.SaveEval("eval_gne_cse.txt")
